...
#ifndef included_pdat_SecondLayerNodeNoCornersFillPattern
#define included_pdat_SecondLayerNodeNoCornersFillPattern
...
/*!
 * Class SecondLayerNodeNoCornersFillPattern is a concrete implementation of
...
public:
    ...
    * Destructor
    */
   virtual ~SecondLayerNodeNoCornersFillPattern();
...
private:
   SecondLayerNodeNoCornersFillPattern(
      const SecondLayerNodeNoCornersFillPattern&);    // not implemented
   void operator=(const SecondLayerNodeNoCornersFillPattern&);         // not implemented
