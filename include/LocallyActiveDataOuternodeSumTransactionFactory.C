//
// File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/algorithm/femutils/locally_active/LocallyActiveDataOuternodeSumTransactionFactory.C $
