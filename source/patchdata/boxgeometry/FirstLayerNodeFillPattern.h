...
#ifndef included_pdat_FirstLayerNodeFillPattern
#define included_pdat_FirstLayerNodeFillPattern
...
/*!
 * Class FirstLayerNodeFillPattern is a concrete implementation of
...
private:
   FirstLayerNodeFillPattern(
      const FirstLayerNodeFillPattern&);    // not implemented
   void operator=(const FirstLayerNodeFillPattern&);         // not implemented
