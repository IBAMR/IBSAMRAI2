...
#ifndef included_pdat_FirstLayerCellFillPattern
#define included_pdat_FirstLayerCellFillPattern
...
/*!
 * Class FirstLayerCellFillPattern is a concrete implementation of 
 ...
 * ghost region of width 1 surrounding a patch, including all edges and
 * corners.
 */
template<int DIM>
...
public:
    ...
    * of width 1 surrounding the patch.  The patch is identified by the
...
private:
   FirstLayerCellFillPattern(
      const FirstLayerCellFillPattern<DIM>&);    // not implemented
   void operator=(const FirstLayerCellFillPattern<DIM>&);         // not implemented
